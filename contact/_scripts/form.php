<?php
	...
	define('DESTINATION_EMAIL','paul@edmiston.org');
	define('MESSAGE_SUBJECT','Received pauledmiston.com contact form');
	define('REPLY_TO', 'form@pauledmistonartdm.com');
	define('FROM_ADDRESS', 'form@pauledmistonartdm.com');
	define('REDIRECT_URL', '..');
	...
	$formsubject = 'Write your subject here.';
	...
	if(@$_POST['submitted'])
	{
		...
		$formsubject = cleanText($formsubject);

		if($formsubject == 'Write your subject here.')
		{
			$error_msg[] = 'Please provide a valid subject.';
			$message_error = "<span class=\"error\">Subject can only contain letters, numbers and basic punctuation \" ' - ? ! </span>";
		}
		...
		if(count($error_msg) === 0)
		{
			...
			echo "<li>".$name."</li>";
			echo "<li>".$email."</li>";
			echo "<li>".$formsubject."</li>";
			echo "<li>".$message."</li>";
			echo "</ul>";
			echo "<a href=\"". REDIRECT_URL ."\">Send me another form</a>";
			exit();
		}
		else
		{
